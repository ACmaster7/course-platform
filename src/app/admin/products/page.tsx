...
import { CourseProductTable, ProductTable as DbProductTable, PurchaseTable } from '@/drizzle/schema';
...
async function getProducts() {
  ...
  }).from(DbProductTable).leftJoin(PurchaseTable, eq(PurchaseTable.productId, DbProductTable.id)).leftJoin(
    CourseProductTable,
