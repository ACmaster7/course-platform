...
function UserPurchaseTable({ purchases }: UserPurchaseTableProps) {
  return (
    <Table>
      <TableHeader>
        <TableRow>
          <TableHead>Prodcut</TableHead>
            ...
            <TableCell>
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-1">
                  <div className="font-semibold">{purchase.productDetails.name}</div>
                  <div className="text-muted-foreground">{formatDate(purchase.createdAt)}</div>
                </div>
              </div>
            </TableCell>
            <TableCell>
