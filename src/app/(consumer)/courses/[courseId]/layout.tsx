...
async function CoursePageLayout({ params, children }: { params: Promise<{ courseId: string }>; children: ReactNode }) {
...
async function SuspenseBoundry({ course }: {
  course: {
    name: string;
    id: string;
    courseSections: {
